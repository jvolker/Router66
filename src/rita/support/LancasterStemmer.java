...
public class LancasterStemmer implements RiStemmerIF
{
  ...
  /************************************************************************
   *Method: ReadRules * Returns: void * Receives: * Purpose: read rules in from
   * stemRules and enters them * into ruleTable, ruleIndex is set up to provide
  ...
  private void initialize()
  {
    ...
    try {
      br = new BufferedReader(new InputStreamReader
          (RiTa.openStream(getClass(), RULES)));
    }
    catch (Exception e1)
    {
  ...
  /********************************************************
   *Method: Clean * Returns: String * Recievs: String str * Purpose: remove all
   * non letter or digit * characters from srt and return *
   ********************************************************/
  ...
  {
    LancasterStemmer p = new LancasterStemmer();
    System.out.println(p.stem("running"));
    if (1==1) return;
    //PaiceHuskStemmer p = new PaiceHuskStemmer(args[2], args[3]);
