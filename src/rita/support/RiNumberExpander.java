 ...
 *
 * Translates the following code from flite:
...
public class RiNumberExpander {
  ...
  return null;
     ...
     * @param  wordRelation  words are added to this Relation
     */
    public static void expandID(String numberString, RiWordRelation wordRelation) {
  ...
  int numberDigits = numberString.length();
     ...
     * @param wordRelation words are added to this Relation
     */
    public static void expandReal(String numberString, RiWordRelation wordRelation) {
